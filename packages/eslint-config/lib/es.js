...
const prettier_js_1 = __importDefault(require("./prettier.js"));
const config = (0, _rule_js_1.concatESConfig)(base_js_1.default, promise_js_1.default, jsdoc_js_1.default, import_js_1.default, unicorn_js_1.default, prettier_js_1.default);
