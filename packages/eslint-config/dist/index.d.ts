...
declare function jsonc(options?: jsonc.Options): Promise<[Config, Config]>;
...
export { type DefineConfigOptions, defineConfig as default, defineConfig, es, ignores, imports, jsonc, node, stylistic, test, ts, unicorn, yml };
