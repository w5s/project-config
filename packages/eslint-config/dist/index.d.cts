...
interface PluginOptionsBase<Rules$1> {
...
//#endregion
export { DefineConfigOptions, defineConfig as default, defineConfig, es, ignores, imports, jsdoc, jsonc, node, stylistic, test, ts, unicorn, yml };
