...
declare function ts(options?: ts.Options): Promise<[{
    ...
    readonly rules: {
        ...
        readonly 'ts/no-unsafe-member-access'?: eslint.Linter.RuleEntry<[]>;
...
declare function unicorn(options?: unicorn.Options): Promise<[{
    ...
    readonly rules: {
        ...
        readonly 'jsdoc/check-alignment'?: eslint.Linter.RuleEntry<[]>;
...
export { type DefineConfigOptions, defineConfig as default, defineConfig, ignores, imports, jsonc, node, ts, unicorn, yml };
