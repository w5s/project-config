...
var require_globals$1 = /* @__PURE__ */ __commonJS({ "../../node_modules/globals/globals.json": ((exports, module) => {
	module.exports = {
		"amd": {
			"define": false,
			"require": false
...
var require_globals = /* @__PURE__ */ __commonJS({ "../../node_modules/globals/index.js": ((exports, module) => {
...
function createRules(prefix) {
	return { [`${prefix}no-unused-vars`]: ["error", { argsIgnorePattern: "^_" }] };
}
	...
	return [{
		...
		languageOptions: {
			...
			globals: {
				...
				...import_globals.default[`es${__w5s_dev.Project.ecmaVersion()}`],
...
const getGitignore = async (cwd, prefix = "") => {
	const gitIgnoreFile = await (0, find_up.default)(node_path.default.join(prefix, ".gitignore"), { cwd });
